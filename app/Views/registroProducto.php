                ...
                <div class="row mt-5">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <form  action="<?= site_url('/registrarProducto')?>" method="POST" class="mt-4">
                            ...
                            <input class="form-control" id="producto" name="producto" type="text" placeholder="Nombre Producto">
                            <br>
                            ...
                            <br>
                            <textarea name="descripcion" class="form-control" id="descripcion" name="descripcion" cols="30" rows="10" placeholder="Descripcion"></textarea>
                            <br>
