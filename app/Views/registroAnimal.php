            ...
            <div class="container mb-5">
                <div class="row mt-5">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <form action="<?=site_url('/registrarMascota')?>" method="POST">
                            <label for="nombre">Nombre: </label>
                            <input class="form-control" id="nombre" name="nombre" type="text" placeholder="Nombre del Animal">
                            <br>
                            <label for="edad">Edad: </label>
                            <input class="form-control" id="edad" name="edad" type="text" placeholder="Edad del Animal">
                            <br>
                            <label for="fotografia">Fotografía: </label>
                            <input class="form-control" id="fotografia" name="fotografia" type="text" placeholder="URL de la fotografia">
                            <br>
